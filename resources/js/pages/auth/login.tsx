...
export default function Login({
    ...
    return (
        <div className="flex h-screen overflow-hidden bg-gray-50 dark:bg-gray-950 transition-colors duration-300">
            ...
            <button
                onClick={toggleLang}
                className="absolute top-4 left-4 bg-white/20 hover:bg-white/30 text-white p-2 rounded-full transition-colors flex items-center space-x-1 backdrop-blur-sm z-50"
            >
            ...
            {/* LEFT: Form */}
            <SlideIn direction="left" className="flex w-full lg:w-1/2 items-center justify-center px-8 overflow-y-auto">
                <div className="w-full max-w-md py-8">
                    ...
                    {status && (
                        <div className="mb-4 rounded-lg bg-green-50 dark:bg-green-900/30 p-4 border border-green-200 dark:border-green-800">
                    ...
                    <h2 className="mb-4 text-center text-lg font-bold text-gray-800 dark:text-white">
                        {t.welcome}
                    </h2>
            ...
            <SlideIn direction="right" delay={0.1} className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-sky-500 to-pink-400 dark:from-gray-900 dark:to-gray-800 flex-col items-center justify-center p-8 relative overflow-hidden">
                <div className="absolute top-[-80px] right-[-80px] w-80 h-80 bg-white/10 dark:bg-white/5 rounded-full" />
                <div className="absolute bottom-[-60px] left-[-60px] w-64 h-64 bg-white/10 dark:bg-white/5 rounded-full" />
                <div className="absolute top-1/2 right-1/4 w-32 h-32 bg-white/5 dark:bg-white/[0.02] rounded-full" />
