        ...
        <div className="space-y-6 p-4 md:p-6">
                ...
                <div className="mt-4">
                    {youtube_connected ? (
                        <Menu as="div" className="relative inline-block">
                            ...
                            >
                                <Menu.Items className="absolute left-0 mt-2 w-48 origin-top-left rounded-xl bg-white dark:bg-gray-800 shadow-lg ring-1 ring-black/5 focus:outline-none z-50 border border-gray-100 dark:border-gray-700">
                                    <div className="p-1">
                                        <Menu.Item>
                                            {({ active }) => (
                                                <Link
                                                    ...
                                                    method="post"
                                                    as="button"
                                                    className={`${active ? 'bg-sky-50 dark:bg-sky-900/20 text-sky-700' : 'text-gray-700 dark:text-gray-200'} flex w-full items-center gap-2 rounded-lg px-3 py-2 text-sm`}
                                                >
            ...
            <div>
                <div className="mb-3 flex items-center justify-between">
                    ...
                    <Link href="/courses" className="text-xs font-medium text-sky-600 dark:text-sky-400 hover:text-sky-700 flex items-center gap-1">
                ...
                {courses.length > 0 ? (
                    <div className="space-y-3">
                        {courses.map((course) => (
                            ...
                            >
                                <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-sky-50 dark:bg-sky-900/20">
                    ...
                    <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-gray-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 py-10 text-center">
                        ...
                        <Link
                            href="/courses/create"
                            className="mt-3 inline-flex items-center gap-1.5 rounded-full bg-sky-600 px-4 py-1.5 text-sm font-medium text-white hover:bg-sky-700 transition-colors"
                        >
