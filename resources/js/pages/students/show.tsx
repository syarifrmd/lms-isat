            ...
            <div className="mx-auto max-w-8xl px-4 py-6 flex flex-col gap-6">
                ...
                <div className="rounded-2xl border border-gray-100 dark:border-gray-700 bg-white dark:bg-gray-800 shadow-sm overflow-hidden">
                    ...
                    {filteredStudents.length > 0 && (
                        <div className="hidden sm:grid sm:grid-cols-[2rem_minmax(0,1fr)_11rem_5rem_7rem_4rem_7rem_5.5rem] sm:items-center gap-4 px-5 py-2 border-b border-gray-100 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-900/20">
                            <span className="text-[11px] font-semibold uppercase tracking-wider text-gray-400">No</span>
                        ...
                        {filteredStudents.length === 0 ? (
                            ...
                            paginatedStudents.map((s, idx) => (
                                ...
                                >
                                    ...
                                    <div className="min-w-0 text-xs text-gray-400 leading-snug break-words" title={s.location ?? '-'}>
                                        {s.location ?? '-'}
                                    </div>
